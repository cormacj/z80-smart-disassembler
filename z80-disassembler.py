...
def main():
    global args, code_org, xrefstr, endaddress, readsize, bin_data, end_of_code, program_counter, asm_file
    global stats_c_labels, stats_d_labels
